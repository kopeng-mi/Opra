...
const Binding BINDINGS[] = {
    ...
    {Action::LookAround, "Ctrl + mouse", "move the camera", "up and down to change the angle, sideways to look across; it eases back", SDL_SCANCODE_UNKNOWN,
     SDL_SCANCODE_UNKNOWN},
    {Action::CameraScale, "Mouse wheel", "camera scale", "0.6x to 3x",
     SDL_SCANCODE_UNKNOWN, SDL_SCANCODE_UNKNOWN},
    ...
    {Action::ZoomReset, "0", "default zoom", "set on the settings screen", SDL_SCANCODE_0,
     SDL_SCANCODE_UNKNOWN},
    ...
    {Action::Map, "G", "system map", "the orrery and the ephemeris for Nereid",
     SDL_SCANCODE_G, SDL_SCANCODE_UNKNOWN},
    {Action::TrueScale, "Y", "true scale", "draws every body at its real radius",
